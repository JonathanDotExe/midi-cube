...
* Very helpful blog post about PolyBLEP - oscilators for anti-aliasing by Martin Finke (I wrote my polyblep function based on his) (http://www.martin-finke.de/blog/articles/audio-plugins-018-polyblep-oscillator/)
...
* Article about chorus effect (https://de.wikipedia.org/wiki/Chorus_(Tontechnik))
