...
RotarySpeakerEffect::RotarySpeakerEffect() {
	cc.register_binding(new TemplateControlBinding<bool>(preset.on, false, true, 22));
	cc.register_binding(new TemplateControlBinding<bool>(preset.fast, false, true, 23));
